...
export default function AnnotatePage() {
  ...
  const [selectedTool, setSelectedTool] = useState<'circle' | 'highlight'>('circle');
  ...
  const handleMouseUp = (e: React.MouseEvent) => {
    ...
    const newAnnotation: Annotation = {
      ...
      color: selectedTool === 'circle' ? '#ef4444' : '#fbbf24',
    };
    ...
    if (selectedTool === 'circle') {
      ...
      newAnnotation.x = (startPos.x + endX) / 2;
      newAnnotation.y = (startPos.y + endY) / 2;
      
      // Show text input for circle annotations
  ...
  const getPreviewAnnotation = () => {
    ...
    if (selectedTool === 'circle') {
      ...
      previewAnnotation.radius = radius;
      previewAnnotation.x = (startPos.x + currentPos.x) / 2;
      previewAnnotation.y = (startPos.y + currentPos.y) / 2;
    } else {
    ...
    >
      <div className="flex h-full">
        <div className="flex-1 overflow-auto">
          ...
          <div className="p-6">
            <h2 className="text-2xl p-2 font-bold text-gray-900 mb-4">Transcription - Annotation Mode</h2>
            <div 
              ref={canvasRef}
              className="relative p-2 cursor-crosshair select-none h-full"
                      ...
                      return (
                        <div key={index} className="mb-4">
                          <p className="text-gray-800 leading-relaxed">
                            ...
                            <span className="font-semibold">{speaker?.name || 'Unknown Speaker'}:</span> 
                            {segment.text}
                          </p>
                        </div>
                      );
                      ...
                      {annotation.type === 'circle' ? (
                        <>
                          <div
                            ...
                            style={{
                              left: annotation.x - (annotation.radius || 0),
                              top: annotation.y - (annotation.radius || 0),
                              width: (annotation.radius || 0) * 2,
                              height: (annotation.radius || 0) * 2,
                          ...
                          {annotation.text && (
                            <>
                              ...
                              <div
                                ...
                                style={{
                                  left: annotation.x + (annotation.radius || 0) * 0.7,
                                  top: annotation.y - (annotation.radius || 0) * 0.7,
                                  width: (annotation.radius || 0) * 0.5,
                                  height: '1px',
                              ...
                              <div
                                ...
                                style={{
                                  left: annotation.x + (annotation.radius || 0),
                                  top: annotation.y - (annotation.radius || 0) - 12,
                      ...
                      <div key="preview">
                        {preview.type === 'circle' ? (
                          <div
                            ...
                            style={{
                              left: preview.x - (preview.radius || 0),
                              top: preview.y - (preview.radius || 0),
                              width: (preview.radius || 0) * 2,
                              height: (preview.radius || 0) * 2,
                  ...
                  {showTextInput && pendingAnnotation && (
                    <>
                      ...
                      <div
                        className="absolute border-2 rounded-full opacity-70"
                        style={{
                          left: pendingAnnotation.x - (pendingAnnotation.radius || 0),
                          top: pendingAnnotation.y - (pendingAnnotation.radius || 0),
                          width: (pendingAnnotation.radius || 0) * 2,
                          height: (pendingAnnotation.radius || 0) * 2,
