...
export async function POST(request: NextRequest) {
  try {
    ...
    // Forward the cookies from the original request to maintain authentication
    ...
    .then(response => {
      console.log('Transcription request sent, response status:', response.status);
    ...
    return NextResponse.json({
      ...
      filename: uniqueFilename,
      filePath: uploadData.path,
      message: 'File uploaded successfully to Supabase Storage. Transcription started.',
    });
  } catch (error) {
