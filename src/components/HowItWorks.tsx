      ...
      <div className="max-w-7xl mx-auto md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            <div className="mb-6">
              <span className="text-2xl font-bold text-primary">{t('step1.number')}</span>
            </div>
              ...
              >
                {(animationState === 'initial' || animationState === 'dragging') && (
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-sm">{t('step1.dropzone')}</p>
                  </div>
                )}
                ...
                {animationState === 'processing' && (
                  <div className="text-center">
                    ...
                    />
                    <p className="text-sm text-blue-600">{t('step1.processing')}</p>
                  </div>
                )}
              </motion.div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            <div className="mb-6">
              <span className="text-2xl font-bold text-primary">{t('step2.number')}</span>
            </div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">
              {t('step2.title')}
            </h3>
                  ...
                  >
                    <div className="text-center">
                      <motion.div
                        ...
                        transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
                      />
                      <p className="text-sm text-blue-600">{t('step2.transcribing')}</p>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
                  ...
                  >
                    {transcriptionLines.slice(0, visibleLines).map((line, index) => (
                      <motion.div
                        ...
                        className="space-y-1"
                      >
                        <div className={`${line.color === 'blue' ? 'text-black-600' : 'text-black-600'
                    ...
                    {visibleLines >= transcriptionLines.length && (
                      ...
                      >
                        <div className="flex justify-between text-xs text-gray-500">
                          <span>{t('step2.duration')}: 5:12</span>
                          <span>{t('step2.accuracy')}: 98.5%</span>
                        </div>
                      </motion.div>
                    )}
                  </motion.div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            <div className="mb-6">
              <span className="text-2xl font-bold text-primary">{t('step3.number')}</span>
            </div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">
              {t('step3.title')}
            </h3>
